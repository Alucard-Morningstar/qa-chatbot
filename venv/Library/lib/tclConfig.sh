...
# installed.
TCL_PREFIX='Z:/Q&A Chatbot/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='Z:/Q&A Chatbot/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='Z:/Q&A Chatbot/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IZ:/Q&A Chatbot/venv\Library\include'
...
TCL_PACKAGE_PATH='Z:/Q&A Chatbot/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LZ:/Q&A Chatbot/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='Z:/Q&A Chatbot/venv\Library\lib\tclstub86.lib'
